      ...
      <template v-else>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <div class="glass-card-strong p-6 text-center">
            <div class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
              {{
                individualUsers.reduce(
                  (sum, u) =>
                    sum + u.standaloneMatches.reduce((s: number, m: any) => s + m.matchCount, 0),
                  0,
                )
              }}
            </div>
        ...
        <div class="glass-card p-6 mb-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-sm text-[var(--color-text-muted)]"
              >共 {{ individualUsers.length }} 位个人用户</span
            >
          </div>
                  ...
                  >
                    ...
                    <span class="text-[var(--color-text-muted)] ml-2">
                      <UBadge
                        :label="
                          (
                            { pending: '待开始', running: '进行中', finished: '已完成' } as Record<
                              string,
                              string
                            >
