...
export const DEFAULT_FIELDS = [
  ...
  { fieldKey: 'contactPhone', fieldName: '联系电话', defaultAppliesTo: 'both', defaultRequired: true },
  { fieldKey: 'contactEmail', fieldName: '电子邮箱', defaultAppliesTo: 'both', defaultRequired: false },
