  ...
  try {
    ...
    return {
      ...
      matches: match.matches.map((m) => ({
        ...
        timer: m.timer ? {
          id: m.timer.id, topicPro: m.timer.topicPro, topicCon: m.timer.topicCon,
          phases: JSON.parse(m.timer.phases), currentPhase: m.timer.currentPhase,
          proRemaining: m.timer.proRemaining, conRemaining: m.timer.conRemaining,
          proRunning: m.timer.proRunning, conRunning: m.timer.conRunning,
        } : null,
      })),
      timer: firstMatchWithTimer?.timer ? {
        id: firstMatchWithTimer.timer.id, matchId: firstMatchWithTimer.timer.matchId,
        topicPro: firstMatchWithTimer.timer.topicPro, topicCon: firstMatchWithTimer.timer.topicCon,
        phases: JSON.parse(firstMatchWithTimer.timer.phases), currentPhase: firstMatchWithTimer.timer.currentPhase,
        proRemaining: firstMatchWithTimer.timer.proRemaining, conRemaining: firstMatchWithTimer.timer.conRemaining,
        proRunning: firstMatchWithTimer.timer.proRunning, conRunning: firstMatchWithTimer.timer.conRunning,
      } : null,
